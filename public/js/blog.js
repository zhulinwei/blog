...
/******/ 	var hotCurrentHash = "38dbd37c60133f480b83"; // eslint-disable-line no-unused-vars
...
__webpack_require__(1)(__webpack_require__(46))
    ...
    var Blog = {
        ...
        create: function create(acticles) {
            ...
            acticles.forEach(function (acticle) {
                ...
                html += '                   <span class="article-dot">.</span>';
                html += '                   <time>';
                html += '                       <strong>' + acticle.meta.updateAt + '</strong>';
                html += '                   </time>';
                html += '               </div>';
                html += '           </section>';
                html += '       </a>';
